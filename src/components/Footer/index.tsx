  ...
  return (
    <footer className={styles.footerWrapper}>
      ...
      <div className={styles.footerText}>
        <p>
          This project is a college assignment created for educational purposes.
          It is intended solely to demonstrate the practical application of
          academic concepts and should not be used for any commercial purposes.
        </p>
      </div>
